...
public class TestCase04 {
    public static void main(String[] args) throws InterruptedException {
        ...
        //TestCase04:Testing Expire Date
        ...
        //incorrect expire date input
        driver.findElement((By.xpath("//input[@id='ctl00_MainContent_fmwOrder_TextBox1']"))).sendKeys("0129");
        String actual = driver.findElement(By.xpath("//span[@id='ctl00_MainContent_fmwOrder_RegularExpressionValidator3']")).getText();

        Assert.assertEquals(actual,"Invalid format. Required format is mm/yy.");
